...
const EVENTS = [
  {
    ...
    over: false,
    intro: `中秋節到了！活動期間打怪有機會撿到「<b>月光碎片</b>」，集滿 <b>${MOON_EX.need} 個</b>就能到<b>說話之島</b>找「<b>月宮玉兔</b>」換一個「<b>中秋禮盒</b>」。禮盒要用「<b>中秋鑰匙</b>」（各村雜貨商販售，${(MOON_KEY_P / 10000).toLocaleString()} 萬金幣）才打得開，開出來的東西包含<b>卷軸、藍鑽、祝福卷軸、BOSS結晶、高階技能書</b>，以及這次新登場的「<b>娃娃契約書</b>」——用了就能直接解鎖一隻娃娃！`,
    rewards: MOON_ROWS,
    steps: [
    ...
    rules: [
      ...
      `活動期間 <b>🪆 娃娃卡片</b>正式開放；<b>抽卡（免費十連與金幣十連）暫不開放</b>，這段時間娃娃的來源就是禮盒裡的契約書。活動結束後金幣十連會開放，免費十連則不再提供。`,
