...
<div class="sub">・1 ~ 39 級免費完整體驗;<b>滿 40 級起</b>,月卡效期外打怪<b>沒有經驗與金幣</b>(圖鑑擊殺也不計),其餘功能照常。<br>・一張月卡 <b>30 天</b>,可以先用先囤,效期<b>疊加</b>。<br>・月卡<b>綁帳號、不綁角色</b> —— 同一個帳號的四隻角色都在效期內,不必分別買。<br>・⚠ <b>但同一時間只能有一隻角色上線,所以離線掛機也只有一隻。</b>換另一隻角色登入時,前一隻的掛機會<b>先結算</b>(跳出離線收益)再換人,<b>不會四隻一起掛</b>。<br>・月卡透過贊助向客服取得,寄到領取頁,背包點「使用」開通;聊天輸入「月卡」可查剩餘天數。</div></div>
...
<tr><td>一次幾隻</td><td><b>一個帳號只能掛一隻</b>。月卡是綁帳號的(四隻角色都能用),但同一時間只能上線一隻角色 ⇒ 換角色登入會把前一隻的掛機<b>先結算</b>再接手,<b>沒辦法四隻一起掛</b></td></tr>
...
<tr><td>伺服器等級</td><td>目前 <b>51</b>(9/18 起;營運視全服進度調整)。角色<b>低於</b>伺服器等級時打怪經驗有追趕加成:<b>每差 1 級 +100%</b>,差 10 級以上封頂 <b>+1000%</b>。例:伺服器 51,角色 41 → +1000%(差 10 級封頂)。高於伺服器等級沒有加成也沒有懲罰</td></tr>
